...
sudo docker exec -w /home/username/ opal23_headpose_container python images_framework/alignment/opal23_headpose/test/opal23_headpose_test.py --input-data images_framework/alignment/opal23_headpose/test/example.tif --database AFLW --save-image
