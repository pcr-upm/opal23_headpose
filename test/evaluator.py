...
class Evaluator:
    def __init__(self, ann_matrices, pred_matrices, use_pyr_format=True):
        ...
        self.use_pyr_format = use_pyr_format
    ...
    def _mean_rotation(self, matrices, tol=0.0001, max_iter=100000):
